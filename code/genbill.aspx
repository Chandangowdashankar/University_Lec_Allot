<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="genbill.aspx.cs" Inherits="Code.genbill" %>
<!DOCTYPE html>
<html lang="zxx">
               ...
               <h1><a class="navbar-brand" href="index.aspx">E-Allotment
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
								<li class="nav-item ">
									<a class="nav-link" href="lechome.aspx">Lecturer Home
										<span class="sr-only">(current)</span>
									</a>
								</li>
								<li class="nav-item  mx-xl-4 mx-lg-3 my-lg-0 my-3">
									<a class="nav-link" href="addpre.aspx">Preferences</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" href="sublists.aspx">Subjects</a>
								</li>
								<li class="nav-item active">
									<a class="nav-link" href="abtclg.aspx">About College</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" href="genbill.aspx">Generate Bill</a>
								</li>
								<li class="nav-item mx-xl-4 mx-lg-3 my-lg-0 my-3">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Eid" HeaderText="Exam Id" 
                            SortExpression="Eid" />
                         <asp:BoundField DataField="Dated" HeaderText="Date" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Dated" />  
                         <asp:BoundField DataField="CName" HeaderText="College Name" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="CName" /> 
                         <asp:BoundField DataField="SubName" HeaderText="Subject Name" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="SubName" /> 
                         <asp:BoundField DataField="EType" HeaderText="Exam Type" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="EType" /> 
                         <asp:BoundField DataField="SCount" HeaderText="Students Count" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="SCount" /> 
                
                                                         
                        <asp:ButtonField ButtonType="Button" CommandName="Gen" HeaderText="" ShowHeader="True" Text="Generate Bill" ControlStyle-Width="150px" />
