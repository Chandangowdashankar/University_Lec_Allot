<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="managesub.aspx.cs" Inherits="Code.managesub" %>
<!DOCTYPE html>
<html lang="zxx">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
								...
								<li class="nav-item mx-xl-4 mx-lg-3 my-lg-0 my-3">
									<a class="nav-link" href="addsub.aspx">Add Subject</a>
								</li>
								<li class="nav-item active">
									<a class="nav-link" href="managesub.aspx">Manage Subject</a>
								</li>
								<li class="nav-item">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Subid" HeaderText="Id" 
                         ...
                         <asp:BoundField DataField="SubName" HeaderText="Subject" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="SubName" />  
                         <asp:BoundField DataField="CName" HeaderText="Course" HeaderStyle-HorizontalAlign="Center"
