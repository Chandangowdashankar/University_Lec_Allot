<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sublists.aspx.cs" Inherits="Code.sublists" %>
<!DOCTYPE html>
<html lang="zxx">
               ...
               <h1><a class="navbar-brand" href="index.aspx">E-Allotment
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
								...
								<li class="nav-item">
									<a class="nav-link" href="abtclg.aspx">Colleges</a>
								</li>
								<li class="nav-item">
