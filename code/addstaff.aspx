<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addstaff.aspx.cs" Inherits="Code.addstaff" %>
<!DOCTYPE html>
<html lang="zxx">
				...
				<table class="style1" style="color:#ffffcc;">
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <span style="font-weight:bolder;font-size:25px;color:white;">Add Staff Page !!!</span></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                        &nbsp;
                        <input type="text" placeholder="Enter staff name" runat="server" 
                                id="name" />
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            Staff Username:</td>
                        <td>&nbsp;
                        <input type="text" readonly="readonly" placeholder="Staff username" runat="server" id="uname" />
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <input id="login" type="button" value="Store Data !!" runat="server" onserverclick="Submit" style="background-color:#B8D4E3;border-radius:5px;width:125px;" />
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
