<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="examcreate.aspx.cs" Inherits="Code.examcreate" %>
<!DOCTYPE html>
<html lang="zxx">
				...
				<table class="style1" style="color:#ffffcc;">
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <span style="font-weight:bolder;font-size:25px;color:white;">Create Exam !!!</span></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            Date :</td>
                        <td>
                        &nbsp;<asp:TextBox placeholder="Date" runat="server" id="dated" ></asp:TextBox>
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            Subject Name :</td>
                        <td>
                        &nbsp;<asp:TextBox placeholder="Enter subject" runat="server" id="sub"  ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            Student Count :</td>
                        <td>
                        &nbsp;<asp:TextBox placeholder="Enter students count" runat="server" id="scount"  ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <input id="login" type="button" value="Create Exam !!" runat="server" onserverclick="Submit" style="background-color:#B8D4E3;border-radius:5px;width:125px;" />
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
