<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lecpre.aspx.cs" Inherits="Code.lecpre" %>
<!DOCTYPE html>
<html lang="zxx">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Subid" HeaderText="Subject Id" 
                         ...
                         <asp:BoundField DataField="SelBy" HeaderText="Selected By" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="SelBy" /> 
