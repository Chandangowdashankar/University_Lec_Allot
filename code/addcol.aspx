<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addcol.aspx.cs" Inherits="Code.addcol" %>
<!DOCTYPE html>
<html lang="zxx">
...
.<div style="width:50%;float:left;margin:0;">
    <img src="./images/col.jpg" style="height:500px;width:100%" />
            </div>
				...
				<table class="style1" style="color:#ffffcc;">
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <span style="font-weight:bolder;font-size:25px;color:white;">Add College !!!</span></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            College Name :</td>
                        <td>
                        &nbsp;<asp:TextBox placeholder="Enter college name" runat="server" id="cname"  ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            College Address :</td>
                        <td>
                        &nbsp;<asp:TextBox placeholder="College Address" runat="server" 
                                id="coladdr" OnTextChanged="subcode_TextChanged" TextMode="MultiLine" Rows="3" Columns="50"></asp:TextBox>
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            College Email :</td>
                        <td>
                        &nbsp;<asp:TextBox placeholder="Enter college email" runat="server" id="cemail"  ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            College Phone :</td>
                        <td>
                        &nbsp;<asp:TextBox placeholder="Enter college phone" runat="server" id="cphone"  ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <input id="login" type="button" value="Add College!!" runat="server" onserverclick="Submit" style="background-color:#B8D4E3;border-radius:5px;width:125px;" />
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
