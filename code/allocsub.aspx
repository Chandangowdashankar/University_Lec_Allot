<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="allocsub.aspx.cs" Inherits="Code.allocsub" %>
<!DOCTYPE html>
<html lang="zxx">
...
<body>
    ...
    <div style="height:700px;background-color:#3366ff;color:black;padding-top:100px;">
           <div class="col-lg-6" style="float:left;">
               <a href="lecpre.aspx">   <img src="./images/addbook.jpg" style="height:500px;width:100%" />
                   <br/>View Preferences</a>
               
 
           </div>

                   <div class="col-lg-6" style="float:left;">
               <a href="examsch.aspx">   <img src="./images/adsub.png" style="height:500px;width:100%" />
                   <br/>Exam Allocation</a>
