<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="verallo.aspx.cs" Inherits="Code.verallo" %>
<!DOCTYPE html>
<html lang="zxx">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Bid" HeaderText="Bill Id" 
                            SortExpression="Bid" />
                         <asp:BoundField DataField="Eid" HeaderText="Exam Id" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Eid" />  
                         <asp:BoundField DataField="Dated" HeaderText="Date" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Eid" /> 
                         <asp:BoundField DataField="Clgname" HeaderText="College" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Clgname" /> 
                         <asp:BoundField DataField="Typer" HeaderText="Type" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Typer" /> 
                         <asp:BoundField DataField="Tot" HeaderText="Total" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Tot" /> 
                
                                                              
                        <asp:ButtonField ButtonType="Button" CommandName="Approve" HeaderText="" ShowHeader="True" Text="Approve" ControlStyle-Width="150px" />
