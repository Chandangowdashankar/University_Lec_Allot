...
namespace Code
{
    public partial class approveusers : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SqlDataSource1.SelectCommand = "SELECT * FROM UserData where UStatus='Pending'";
            }
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                {
                    con.Open();
                    string query = "Update UserData set UStatus='Approved' where Username='" + row.Cells[0].Text + "';";
