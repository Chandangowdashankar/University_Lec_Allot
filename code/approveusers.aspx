<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="approveusers.aspx.cs" Inherits="Code.approveusers" %>
<!DOCTYPE html>
<html lang="zxx">
            ...
            <h3>Manage Subjects page !!!</h3><br />
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:ButtonField ButtonType="Button" CommandName="Delete" HeaderText="" ShowHeader="True" Text="Approve" ControlStyle-Width="150px" />
