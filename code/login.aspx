...
.<div style="width:50%;float:left;margin:0;">
    <img src="./images/lock.png" style="height:500px;width:100%" />
            </div>
	...
	<form id="form1" runat="server">
			<table class="style1" style="color:#ffffcc;padding-top:100px;">
                    <tr>
                        <td>
                            &nbsp;</td>
                        <td class="style2">
                        ...
                        <td align="center" colspan="2">
                            <span style="font-weight:bolder;font-size:25px;color:#FFFF;">Welcome to the login page !!!</span></td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;
                        <input type="text" placeholder="Enter the username" runat="server" id="uname" />
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                        &nbsp;
                        <input type="password" placeholder="Enter the password" runat="server" id="pswd" />
                            &nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="logi" runat="server" Text="Login" OnClick="Login"  style="background-color:#B8D4E3;border-radius:5px;width:95px;" />
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="style2">
                            &nbsp;</td>
                        <td align="center" colspan="2">
                            <a href="register.aspx"> Sign up here !!!</a>&nbsp;</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="style2">
                            &nbsp;</td>
                        <td align="center" colspan="2">
                            <a href="forgotpassword.aspx">Forgot Password !!!</a></td>
                        <td>
                            &nbsp;</td>
                    </tr>
