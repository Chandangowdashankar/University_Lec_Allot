<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="abtclg.aspx.cs" Inherits="Code.abtclg" %>
<!DOCTYPE html>
<html lang="zxx">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Cid" HeaderText="College Id" 
                         ...
                         <asp:BoundField DataField="CAddress" HeaderText="College Address" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="CAddress" /> 
                         <asp:BoundField DataField="CEmail" HeaderText="College Email" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="CEmail" /> 
                         <asp:BoundField DataField="CPhone" HeaderText="College Phone" HeaderStyle-HorizontalAlign="Center"
