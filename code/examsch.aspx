<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="examsch.aspx.cs" Inherits="Code.examsch" %>
<!DOCTYPE html>
<html lang="zxx">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Eid" HeaderText="Exam Id" 
                         ...
                         <asp:BoundField DataField="AllotLec" HeaderText="External" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="AllotLec" /> 
                
                                                              
                        <asp:ButtonField ButtonType="Button" CommandName="Delete" HeaderText="" ShowHeader="True" Text="Fetch External" ControlStyle-Width="150px" />
