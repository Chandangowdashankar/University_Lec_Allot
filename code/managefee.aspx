<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="managefee.aspx.cs" Inherits="Code.managefee" %>
<!DOCTYPE html>
<html lang="zxx">
...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
								...
								<li class="nav-item mx-xl-4 mx-lg-3 my-lg-0 my-3">
									<a class="nav-link" href="setfee.aspx">Set Fee</a>
								</li>
								<li class="nav-item active">
									<a class="nav-link" href="managefee.aspx">Manage Fee</a>
								</li>
								<li class="nav-item mx-xl-4 mx-lg-3 my-lg-0 my-3">
 ...
 <div style="height:700px;background-color:#3366ff;color:black;padding-top:100px;">
        <div style="width:15%;float:left;margin:0;">.
            ...
            <h3>Manage Fees page !!!</h3><br />
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    CellPadding="4" DataSourceID="SqlDataSource1" 
                    EmptyDataText="There are no data records to display." ForeColor="#333333" 
                    GridLines="None" Width="800px" OnRowCommand="GridView1_RowCommand" OnRowDeleted="RowDelete">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" CssClass="abc" HorizontalAlign="Left" />
                    <Columns>
                    
                        <asp:BoundField DataField="Feeid" HeaderText="Id" 
                            SortExpression="Feeid" />
                         <asp:BoundField DataField="Course" HeaderText="Course" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Course" />  
                         <asp:BoundField DataField="Fee" HeaderText="Fee" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Fee" /> 
