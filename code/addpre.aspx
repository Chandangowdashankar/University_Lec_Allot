<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addpre.aspx.cs" Inherits="Code.addpre" %>
<!DOCTYPE html>
<html lang="zxx">
              ...
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Subid" HeaderText="Subject Id" 
                         ...
                         <asp:BoundField DataField="SubCode" HeaderText="Subject Code" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="SubCode" /> 
                      <asp:BoundField DataField="Course" HeaderText="Course" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Course" /> 
                         <asp:BoundField DataField="Sem" HeaderText="Sem" HeaderStyle-HorizontalAlign="Center"
                            SortExpression="Sem" /> 
                
                                                              
                        <asp:ButtonField ButtonType="Button" CommandName="Pre" HeaderText="" ShowHeader="True" Text="My Preference" ControlStyle-Width="150px" />
